Name:                       ingrid-interface-search
Version:                    0.0.0
Release:                    dev
Summary:                    InGrid Interface Search
...
%define target              %{buildroot}/opt/ingrid/ingrid-interface-search
%define systemd_dir         /usr/lib/systemd/system
%define ingrid_unit_name    ingrid-interface-search.service
...
unzip -qq "${WORKSPACE}/target/ingrid-interface-search-[0-9]*-installer.jar"
...
# interface-search
mkdir -p %{target}/logs
mv ./ingrid-interface-search-*/* %{target}
...
%attr(0755,ingrid,ingrid) /opt/ingrid/ingrid-interface-search
...
# system.
if [ -f "/etc/systemd/system/ingrid-interface-search.service" ]; then
  service ingrid-interface-search stop
fi
